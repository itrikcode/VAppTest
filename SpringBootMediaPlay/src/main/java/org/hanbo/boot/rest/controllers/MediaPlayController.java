...
import org.hanbo.boot.rest.services.MediaStreamLoader;
...
public class MediaPlayController {
   ...
   public ResponseEntity<StreamingResponseBody> playMediaV01(
      ...
      try {
         ...
         String filePathString = "E:\\09-June-New Batch Recoding\\New folder\\Untitled 366.mp4";
   ...
   public ResponseEntity<StreamingResponseBody> playMediaV02(
      ...
      try {
         String filePathString = "<Place with your own media file full path>";
         ResponseEntity<StreamingResponseBody> retVal = mediaLoaderService.loadPartialMediaFile(filePathString,
               rangeHeader);
